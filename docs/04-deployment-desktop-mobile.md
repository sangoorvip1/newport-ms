...
- `npm run e2e -w @newport/api` → **83/83** (دخان حيّ على HTTP: بطاقة الجذر، جلسة، قيد تغيير كلمة المرور،
...
API_URL=http://127.0.0.1:3000/api npm run e2e -w @newport/api   # 83/83
...
| 4 | المزامنة تعمل من جهاز حقيقي/محاكي | `npm run e2e -w @newport/api` → 83/83 ✅ |
